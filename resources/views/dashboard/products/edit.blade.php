...
<div class="row mx-3">
    <div class="col-lg-9">
        <form class="theme p-4" action="{{ route('admin.products.update', $product->id) }}" enctype="multipart/form-data" method="post">
            @csrf
            @method('put')
            <div class="row">
                <div class="col-lg-6">
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <x-form.input name="quantity" :value="$product->quantity"/>                    
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
