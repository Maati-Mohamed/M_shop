...
<div class="">
    <form class="theme p-3" action="{{ route('admin.roles.store') }}" method="post">
        @csrf

        <div class="mb-3">
            <label for="" class="form-label">@lang('Role Name')</label>
            <x-form.input name="name" />
        </div>
        <div class="mb-3">
            <label for="" class="form-label">@lang('Display Name')</label>
            <x-form.input name="display_name" />
        </div>
        <div class="mb-3">
        ...
        <button type="submit" class="btn MyBtn">@lang('Add')</button>
    </form>
